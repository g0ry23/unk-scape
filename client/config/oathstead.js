...
// ─────────────────────────────────────────────────────────────────────────────
// UNKSCAPE — OATHSTEAD DATA PACK v1.0
// Step 1: Town record, districts, NPC service roles (bank only), economy profile
...
US.TOWNS.town_oathstead_village = {
  ...
  notes:            'Step 1 alpha: bank NPC live. Vendor/trainers added in subsequent steps.'
};
